...
<div id="main_container">
		<div id="left_menu">
			...
			<ul class="subMenu">
				...
				<li class="selected"><a href="system.cgi?section=backup&subsection=restore">Restore</a></li>
...
<h3>This page allows to restore user configuration
</h3>

<form id="mainFormRestore" method="post" action="sendResult.cgi?section=backup&subsection=restore" enctype="multipart/form-data">
<input type="hidden" name="page" value="system" />
<input type="hidden" name="action" value="restore" />
<input type="hidden" name="token_csrf" value="e929068515100abe6137a96817c7d66a" />
    <input type="hidden" name="bkpPass" value="" />
...
<div id="errorBox">
    ...
    <table id="restoreTab">
        <tr>
            <td colspan="2">
               Please specify the password if you want to restore encrypted configuration
        ...
        <tr>
            <td>
                <div class="buttons_container leftButtons" id="selFileButtonDiv">
                    <div class="button" id="selectFileButton">Select File</div>
                </div>
            </td>
            <td>
                    <input type="file" id="fileInputBar" name="backupFile" />
            </td>
        </tr>
    </table>
    <div class="buttons_container" id="restoreButtonDiv">
        <div class="button" id="restoreButton">Restore
</div>
    </div>
    <br style="clear: both"/>
</div>
<input type="submit" name="hiddenSubmit" id="hiddenSubmit" style="display:none" />
</form>

<script type="text/javascript" src="../js/jquery.ui.fileinput.js"></script>

<script type="text/javascript">
            upcApp.specificPageBehaviour = upcApp.system.backup.restore.pageBehaviour;
</script>
</div>
	</div>
</body>
