...
<div id="main_container">
		<div id="left_menu">
			<ul>
				<li class="selected"><a href="system.cgi?section=password">Password</a></li>
			</ul>
...
<h3>This page allows to change system password
</h3>
<form id="mainForm" method="post" action="sendResult.cgi?section=password">
...
<script type="text/javascript">
		upcApp.specificPageBehaviour = upcApp.system.password.pageBehaviour;
</script>
</div>
	</div>
</body>
